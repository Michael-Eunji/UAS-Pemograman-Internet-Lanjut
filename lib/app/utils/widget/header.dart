...
class header extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    child: TextField(decoration: InputDecoration(filled: true, fillColor: Colors.white,
            ...
            const Icon(Icons.notifications,color: Color.fromARGB(255, 3, 3, 3),size: 30,),
             const SizedBox(width: 20,),
            GestureDetector(
    onTap: (){
    ...
    child: Row(
      children: [
        const Text('Sign Out', style: TextStyle(color: Color.fromARGB(255, 6, 6, 6),fontSize: 18),),
        const SizedBox(width: 5,),
       const Icon(Icons.logout_outlined,color: Color.fromARGB(255, 0, 0, 0),size: 30,),
      ],
    ),
            ),
            ],
